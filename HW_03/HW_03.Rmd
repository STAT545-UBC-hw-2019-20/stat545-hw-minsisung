...
Here, I used the two ways to show the spread of GDP per capita within the continent.

First one used geom_point to plot the GDP per capita of all the countries which are in the same cotinent. Also use the table with differnet colors for each cotinent to fulfill the optional exercise
```{r}
